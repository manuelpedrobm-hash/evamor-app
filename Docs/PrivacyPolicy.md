# Política de privacidad de Ecuanimidad
...
Los datos guardados en el iPhone son necesarios para prestar el propio servicio (recordar tu configuración e historial). La sincronización con iCloud, la función Amigos y la descarga desde el catálogo remoto son opcionales y solo se activan si tú los enciendes explícitamente: la base legal de esos tratamientos es tu consentimiento, que puedes retirar en cualquier momento desde Ajustes.

## Conservación

No fijamos un plazo de borrado automático porque casi todo el tratamiento ocurre en tu propio dispositivo o en tu propia base privada de iCloud, bajo tu control. Los datos se conservan mientras mantengas la aplicación instalada o hasta que uses las opciones de borrado descritas arriba; al eliminar la aplicación o tu cuenta de iCloud, los datos guardados en tu base privada de CloudKit se eliminan según la política de Apple para bases privadas de usuario.
...
Puedes ejercer tus derechos de acceso, rectificación, supresión, oposición, limitación y portabilidad escribiendo a [manuelpedrobm@gmail.com](mailto:manuelpedrobm@gmail.com). Como la mayoría de tus datos ya están bajo tu control directo (en el dispositivo o en tu propia iCloud), muchos de estos derechos puedes ejercerlos tú mismo desde la aplicación sin esperar respuesta. También puedes reclamar ante la Agencia Española de Protección de Datos ([www.aepd.es](https://www.aepd.es)) si consideras que no se han respetado tus derechos.

## Menores

Ecuanimidad no está dirigida específicamente a menores de 14 años y no solicita ni verifica la edad de quien la usa.

## Cambios

Si esta política cambia, se actualizará en esta misma dirección y en la ficha de la aplicación en el App Store.

---

*Este texto es un borrador razonable para una app sin publicidad ni analítica de terceros, pero no sustituye la revisión de un abogado especializado en protección de datos si quieres una cobertura legal completa antes de operar a mayor escala.*
